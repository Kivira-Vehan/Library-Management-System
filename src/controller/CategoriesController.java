...
public class CategoriesController {
    ...
    @FXML
    private TextField txtCategoriesID;

    @FXML
    private TextField txtCategoriesName;
    ...
    public void initialize() throws ClassNotFoundException, SQLException {
        ...
        colcategoryname.setCellValueFactory(new PropertyValueFactory<>("CategoriesName"));
    ...
    public void getAllCategories() throws ClassNotFoundException, SQLException {
        ...
        for (Categories cater : categoriesList) {
            ...
            CategoriesTM categoriesTM = new CategoriesTM(
                    cater.getCategoriesID(),
                    cater.getCategoriesName(),
                    button);
    ...
    void btnSaveOnAction(ActionEvent event) throws SQLException, ClassNotFoundException {
        String CategoriesID = txtCategoriesID.getText();
        String CategoriesName = txtCategoriesName.getText();


        Categories categories = new Categories(CategoriesID,CategoriesName);
        System.out.println(categories);

        Connection connection = DBConnection.getInstance().getConnection();

        PreparedStatement statement = connection.prepareStatement("INSERT INTO categories VALUES (?,?)");
        statement.setObject(1, categories.getCategoriesID());
        statement.setObject(2, categories.getCategoriesName());
