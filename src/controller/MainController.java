...
public class MainController {
    ...
    void btnBookOnAction(ActionEvent event) throws IOException {
        Parent root3 = FXMLLoader.load(this.getClass().getResource("/view/Books.fxml"));
    ...
    void btnBorrowOnAction(ActionEvent event) throws IOException {
        Parent root4 = FXMLLoader.load(this.getClass().getResource("/view/Borrow.fxml"));
        Stage stage = new Stage();
    ...
    @FXML
    void btnCategariesOnAction(ActionEvent event) throws IOException {
